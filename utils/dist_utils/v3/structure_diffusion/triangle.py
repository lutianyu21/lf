...
def pack_one(t: torch.Tensor, pattern: str) -> tuple[torch.Tensor, callable]:
    ...
    def unpack_one(to_unpack, unpack_pattern=None):
        ...
        """
        if unpack_pattern is None:
            unpack_pattern = pattern
...
class Attend(nn.Module):
    ...
    def local_attn(
        ...
        windowed_mask: torch.Tensor | None = None,
        ...
        if attn_bias is not None and is_full_attn_bias:
    ...
    def forward(
        ...
        **kwargs
        ...
        if self.need_transpose:
            pairwise_repr = pairwise_repr.transpose(1, 2)
...
class SwiGLU(nn.Module):
    def forward(
        ...
        return nn.functional.silu(gates) * x
