...
# 数据路径 (可通过环境变量覆盖)
BQ_PATH="${BQ_PATH:-/SPXvePFS/share/llmfolding/lf/dataset/v3.1/bq_pdb.parquet}"
STRUCT_DIR="${STRUCT_DIR:-/SPXvePFS/share/llmfolding/lf/data/rcsb/raw}"
DATASET="${DATASET:-rcsb}"
...
# 处理参数 (根据 GPU 数量自适应)
# 注意: PDB 结构比 AlphaFold 大，使用更小的 BSZ 避免 OOM
